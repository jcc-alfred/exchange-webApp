        ...
        return (
            ...
            <div className="showDataBox">
                ...
                <div className="box_header">
                                ...
                                <div className="searchItem">
                                    ...
                                    <div className="itemContentDiv">
                                        {this.state.currentExList.map((item,key)=>{
                                            return <div key={key} className="itemsDiv" onClick={this.toPage.bind(this,`/exchange/${item.coin_exchange_id}`)}>{/*onClick={this.event_changeCoinEx.bind(this,item.coin_exchange_id)}*/}
                    ...
                    <div className="dayDataBox">
                        <p className={this.state.currentMarket && this.state.orderList && this.state.orderList.length > 2 ? (this.state.currentMarket.market.last_price >= this.state.orderList[1].trade_price ? "show_count greenColor" : "show_count redColor") : "show_count"}>
                        ...
                        <p className="show_text">{lang.get('最新价格')}</p>
                    </div>
                    <div className="dayDataBox">
                        <p className="show_count greenColor">{this.state.currentMarket ? Utils.fixNumber(this.state.currentMarket.market.high_price,this.state.coinEx.exchange_decimal_digits) : '--'}</p>
                        <p className="show_text">{lang.get('24H最高价')}</p>
                    </div>
                    <div className="dayDataBox">
                        <p className="show_count redColor">{this.state.currentMarket ? Utils.fixNumber(this.state.currentMarket.market.low_price,this.state.coinEx.exchange_decimal_digits) : '--'}</p>
                        <p className="show_text">{lang.get('24H最低价')}</p>
                    </div>
                    <div className="dayDataBox">
                        <p className={this.state.currentMarket ? this.state.currentMarket.market.change_rate<0 ?"show_count redColor" :"show_count greenColor" : "show_count" }>
                            {(this.state.currentMarket ? (this.state.currentMarket.market.change_rate * 100).toFixed(2) : '--') + '%'}</p>
                        <p className="show_text">{lang.get('24H涨跌幅')}</p>
                    </div>
                    <div className="dealMoneyBox">
                        <p className="show_count">{this.state.currentMarket ? Utils.fixNumber(this.state.currentMarket.market.total_amount,this.state.coinEx.exchange_decimal_digits) : '--'}</p>
                        <p className="show_text">{lang.get('24H成交额')}</p>
                    </div>
                    <div className="K_line_btn" onClick={this.toPage.bind(this,`/market/${this.state.coinEx.coin_exchange_id}`)}>
                        <i className="icon_kline"></i>
                        <span>{lang.get('K线交易')}</span>
                    </div> 
                </div>
                        ...
                        <div className="content_vertil">
                            <div className="vertilDiv1">
                                <div className="vertilDivTop">
                                    ...
                                    <div className="topCount greenColor"><span>{this.state.coinExchangeAssets.assets ? this.state.coinExchangeAssets.assets.available : '--'}</span></div>
                                </div>
                                <div className="vertilDivTop">
                                    <div className="available"><span>{lang.get('可买')}</span></div>
                                    <div className="unit"><span>{this.state.coinEx.coin_unit}</span></div>
                                    <div className="topCount"><span>
                                        {this.state.coinExchangeAssets.assets && this.state.buyPrice ? Utils.fixNumber(this.state.coinExchangeAssets.assets.available/this.state.buyPrice,this.state.coinEx.decimal_digits) : '--'}</span>
                                    </div>
                                </div>
                            </div>
                            <div className="vertilLine"></div>
                            <div className="vertilDiv1">
                                <div className="vertilDivTop">
                                    <div className="available"><span>{lang.get('可用')}</span></div>
                                    <div className="unit"><span>{this.state.coinEx.coin_unit}</span></div>
                                    <div className="topCount redColor"><span>{this.state.coinAssets.assets ? this.state.coinAssets.assets.available : '--'}</span></div>
                                </div>
                                <div className="vertilDivTop">
                                    <div className="available"><span>{lang.get('可卖')}</span></div>
                                    <div className="unit"><span>{this.state.coinEx.exchange_coin_unit}</span></div>
                                    <div className="topCount"><span>
                                        {this.state.coinAssets.assets && this.state.sellPrice ? Utils.fixNumber(this.state.coinAssets.assets.available*this.state.sellPrice,this.state.coinEx.exchange_decimal_digits) : '--'}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
